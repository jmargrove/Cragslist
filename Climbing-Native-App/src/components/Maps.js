    ...
    return(
      <View style={{flex: 1}}>
        ...
        <View style={{flex: 2, justifyContent: 'space-around', flexDirection: 'row', backgroundColor: 'white', alignItems: 'flex-start'}}>
          <Text style={{fontSize: 30, fontFamily: 'Helvetica', fontWeight: 'regular' }}>{Math.round(theProps.locationToView.coordinate.latitude*100)/100}°</Text>
          <Text style={{fontSize: 30, fontFamily: 'Helvetica', fontWeight: 'regular'}}>{Math.round(theProps.locationToView.coordinate.longitude*100)/100}°</Text>
        </View>
      </View>
    )
  }
      ...
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          <View style={styles.headerbutton}>
            ...
            <TouchableOpacity styles={{width: 105}}
              onPress={() => {
                this.setModalVisible(!this.state.modalVisible)
              }}>
